...
export default function RegisterForm() {
  ...
  <div className="inputForm" >
    ...
    <input  value={name}  controlId='name'  onChange={(e) => setName(e.target.value)} type="name" className="input" placeholder="Enter your name" />
  </div>
  ...
  <p className="p">
    Already having existing account? <span className="span"><Link to='/login'>Sign In</Link></span>
  </p>
